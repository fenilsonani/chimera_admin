!function () {
    ...
    function u() {
        feather.replace();
        var e, t, a = "/" == location.pathname ? "index" : location.pathname.substring(1);
    ...
    function g() {
        var e = "/" == location.pathname ? "index" : location.pathname.substring(1);
